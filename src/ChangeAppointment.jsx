...
const ChangeAppointment = ({ route, navigation }) => {
  ...
  const getAppointmentById = async () => {
    try {
      const response = await axios.post(`${Base_url}/userAppointment/getAppointmentById`, { Id: id });
  ...
  const handleChangeSubmit = async () => {
    try {
        if (patientName && contactNo && appointmentDate && appointmentTime && reasonForBooking) {
           ...
           const response = await axios.post(`${Base_url}/userAppointment/getAppointmentUpdateById`, {
